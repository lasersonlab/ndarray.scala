...
import org.lasersonlab.ndarray.TList.`1`
import org.lasersonlab.zarr
import org.lasersonlab.zarr.{ Array, Suite, VectorInts }
...
class LoadTest
  ...
  test("load") {
    ...
    import Array.loadArr

    !![VectorInts.Ax[_1, `1`, Int]]

    Array.loadArr[Obs, _1, `1`]: Load[Array.S[`1`, Idx,   Obs]]

    !![Load[Array.S[`1`, Idx,   Obs]]]
